...
public class TestTreeSitterJavaGenerator {
    ...
    public void testSimpleSyntax() throws IOException {
     ...
     public void testMethodInvocation() throws IOException {
         String input = "class Main {\n"
                 ...
                 + "    }\n"
                 + "}\n";
         TreeContext ctx = new TreeSitterJavaTreeGenerator().generateFrom().string(input);
         ...
         input = "class Main {\n"
                 ...
                 + "    }\n"
                 + "}";
         ctx = new TreeSitterJavaTreeGenerator().generateFrom().string(input);
...
//     }
     ...
     public void testTypeDefinition() throws IOException {
         ...
         TreeContext ct1 = new TreeSitterJavaTreeGenerator().generateFrom().string(input1);
         TreeContext ct2 = new TreeSitterJavaTreeGenerator().generateFrom().string(input2);
